...
const transectionModel= require('../models/transectionModal')
...
const editTransection = async(req,res)=>{
    try {
        ...
        res.status(201).send('Transection Edited successfully')
...
const deleteTransection = async(req,res)=>{
    try {
        ...
        res.status(201).send('Transection Deleted successfully')
